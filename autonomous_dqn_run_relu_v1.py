...
from DQN_relu import DQN_relu
from DQN_relu import load_table
from DQN_relu import save_table
##from DQN_relu import calculate_reward
...
##        dqn = DQN_relu(5,15,3)
        if save_weights.upper() == 'Y':
            ...
            dqn = DQN_relu(5,15,3,w1_pre,w2_pre)
