...
from DQN import DQN
from DQN import load_table
from DQN import save_table
...
crash_dist = 12
epsilon = 0.9   # The randomness of chosen action, used for discovery.
